...
#     if task == "Goal_Arm3_8Hazards_Pillar":
#         config = {
#             # robot setting
#             'robot_base': 'xmls/arm_3.xml', 
#             'robot_locations':[(0.0,0.0)],
...
#             'pillars_num': 1,
#             'pillars_size': 0.4,
#             # 'pillars_z_range': [0.5, 1.5],
#         }

#     if task == "Defense_Arm3_8Hazards_Pillar":
#         config = {
#             # robot setting
#             'robot_base': 'xmls/arm_3.xml', 
#             'robot_locations':[(0.0,0.0)],
...
def configuration_list(task):
    ...
    if task == "Goal_Arm3_8Hazards":
        config = {
            ...
            # 'arm_velocity_threshold': 4.0,  #modif
            # 'constrain_velocity': False,
        }
    if task == "Goal_Arm3_2Hazards":
        config = {
            # robot setting
            'robot_base': 'xmls/arm_3.xml', 
            'robot_locations':[(0.0,0.0)],
